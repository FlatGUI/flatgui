 ...
 */
public class FGPhotoApp
{
    public static final String CONTAINER_NS = "pa";
    public static final String CONTAINER_VAR_NAME = "papanel";
    ...
    public static void main(String[] args)
    {
        EventQueue.invokeLater(() -> {
            try
            {
                ...
                Frame frame = new Frame("DL Personal Page");
                ...
                InputStream is = FGCompoundDemoServer.class.getClassLoader().getResourceAsStream("flatgui/samples/forms/pa.clj");
